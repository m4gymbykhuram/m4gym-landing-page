        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start gap-3 md:gap-6">
            <Link href="/" className="flex items-center gap-2">
              <span className="bg-primary-gradient font-anton text-bg-base text-4xl font-bold px-2 py-1 leading-none">
                M4
              </span>
              <span className="font-anton text-white text-4xl tracking-widest uppercase">
                GYM
              </span>
            </Link>
            {/* Social Icons */}
          ...
          <div className="text-center md:text-start">
            <h3 className="font-archivo text-white/40 text-sm  uppercase tracking-widest mb-5">
              Explore
            </h3>
            <ul className="flex flex-col gap-3">
              {exploreLinks.map((item) => (
                <li key={item}>
                  <Link
                    href="#"
                    className="font-archivo text-white text-md transition-colors duration-200"
                  >
                    {item}
                  </Link>
                </li>
            ...
            <ul className="flex flex-col gap-3">
              {solutionLinks.map((item) => (
                <li key={item}>
                  <Link
                    href="#"
                    className="font-archivo text-white text-md font-medium transition-colors duration-200"
                  >
                    {item}
                  </Link>
                </li>
