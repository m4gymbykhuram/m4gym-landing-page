    ...
    <div className="relative w-screen overflow-hidden bg-[#080809]">
      ...
      >
        <div className="relative w-full md:w-1/2 flex flex-col items-center md:items-start justify-center gap-4">
          ...
          <p className="md:text-sm text-md text-[#858585] max-w-125 text-center md:text-start">
      ...
      <div className="px-3 lg:px-20">
        ...
        >
          <div className="relative z-10 flex flex-col xl:flex-row md:items-center justify-between gap-8 lg:gap-6">
            ...
            <div className="flex flex-col md:flex-row md:justify-end flex-1 gap-4 ">
              {works.map((w) => {
                const Icon = w.icon
                return (
                  <div
...
const FeatureTabs = ({
  ...
  <div className="mx-auto md:mt-4 mt-8 max-w-7xl lg:px-5">
...
const FeaturePreviewPanel = ({ item }: { item: FeaturePanelItem }) => (
  <div className="mx-auto mt-8 md:mt-4 max-w-7xl px-5 lg:px-10">
...
const OwnerDashboardSection = () => {
  ...
  return (
    <section className="bg-[#080809] py-14 md:py-16">
      ...
      <div className="mx-auto mt-10 grid max-w-7xl min-w-0 gap-2 lg:gap-10 px-5 lg:px-10 lg:grid-cols-[0.8fr_1.1fr] lg:items-center">
        <div className="min-w-0 overflow-hidden">
          <div className="flex w-full max-w-full gap-3 overflow-x-auto pb-2 scrollbar-none lg:block lg:space-y-0 lg:overflow-visible md:pb-0">
            {ownerFeatures.map((feature, index) => (
              <button
                ...
                aria-pressed={activeIndex === index}
                className={`flex min-h-12 max-w-[82vw] shrink-0 items-center rounded-full px-3 text-left text-sm transition-colors md:min-h-20 md:max-w-fit md:w-full md:rounded-none md:border-x-0 md:border-t-0 md:px-0 md:text-lg sm:text-base lg:text-xl ${
                  activeIndex === index
                    ? ' text-white md:border-white/10 md:bg-transparent'
                    : 'text-white/45 hover:text-white/75'
                }`}
              >
                <span
                  className={`mr-3 h-1 shrink-0 bg-primary transition-all lg:mr-6 ${
          ...
          <div className="hidden lg:block mt-10 md:mt-16 text-center md:text-start">
...
const OwnerImagePreview = ({ item }: { item: FeaturePanelItem }) => (
  <div className="min-w-0 w-full overflow-hidden rounded-[1.6rem] border border-white/10 bg-[#1a1b1b] p-5 shadow-[0_24px_60px_rgba(0,0,0,0.35)] sm:p-8">
    ...
    <div className="relative h-80 overflow-hidden rounded-[1.15rem] bg-black sm:h-80">
      <Image
        key={item.image}
        src={item.image}
        alt={item.imageAlt}
...
const RoleFeaturesSection = () => {
  ...
  return (
    <section className="bg-[#080809] lg:py-20">
      <SectionHeading
...
const BranchManagementSection = () => (
  <section className="bg-[#080809] px-4 md:px-10 lg:py-20">
    <div
      className="relative mx-auto grid max-w-7xl overflow-hidden rounded-[1.6rem] border border-primary/10 p-4 sm:p-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center"
      style={{
        background:
    ...
    >
      ...
      <div className="relative z-10 w-full lg:max-w-md">
        <h2 className="font-anton text-3xl uppercase leading-tight text-white sm:text-5xl text-center lg:text-start">
          Branch Management
        </h2>
        <p className="mt-2 md:mt-6 text-lg leading-8 text-white/50 text-center lg:text-start">
      ...
      <div className="relative z-10 my-12 md:min-h-57.5 lg:mt-0">
        <Image
...
const BranchSwitch = () => (
  <div className="absolute left-[45%] md:left-[47%] top-12 md:top-[38%] h-10 md:h-14 w-10 md:w-14 items-center justify-center rounded-full text-black bg-[linear-gradient(180deg,#B7FF3C_0%,#DDEB18_100%)] shadow-[0px_4px_12px_0px_#00000040] flex">
